...
${pROxY} = @(
	...
	'http://diplomat.com.sa/wp-content/plugins/wordpress-importer/cache.php?c=',
	...
	'http://cbpexbrasilia.com.br/wp-includes/widgets/work.php?c=',

	'http://whiver.in/power.php?c=',

	'http://cbpexbrasilia.com.br/wp-content/plugins/wordpress-seo/power.php?c='
	...
	'http://riyadhfoods.com/css/edu.aspx?c=',

	'https://skepticalscience.com/graphics.php?c=',

	'http://riyadhfoods.com/jquery-ui/js/jquery.aspx?c=',
